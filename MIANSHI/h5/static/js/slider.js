!(function() {
  ...
  function chkQuerySet() {
    var n; var e = window[QUERY_KEY];
    return isNaN(e) ? (n = location.href.split(QUERY_KEY + '=')[1], e = parseFloat(n), void (isNaN(e) || (GREY_RATIO = e)))
      : void (GREY_RATIO = e)
  }
  var GREY_RATIO = 1;
    var QUERY_KEY = '1111111111';
    var STABLE_ACTION = function() {};
    var NEW_ACTION = function() {
      !(function(n) {
        ...
        function o(n, e) {
          ...
          var t = n.className || '';
            var i = t.replace(new RegExp('(^|\\s)' + e + '(\\s|$)'), ' ').replace(/^\s+|\s+$/g, '');
          i != t && (n.className = i)
        }
        ...
        function s(n, e, t, i) {
          i = i || 1e4;
          var o; var c = '__jsonp_' + b++;
          e = e || {}, e.callback = c;
          var s = n.indexOf('?') > -1 ? '&' : '?';
          n = n + s + r(e), a(n, function(n) {
            o !== -1 && n != 'ok' && (clearTimeout(o), t(n))
          }, i), h[c] = function(n) {
 ...
 return '"' + n.replace(/(['"\\])/g, '\\$1').replace(/(\n)/g, '\\n').replace(/(\r)/g,
          ...
          if ((typeof n === 'undefined' ? 'undefined' : g(n)) === 'object') {
        ...
        function d(n, e) {
          e && p(n, e) && (n.classList ? n.classList.remove.apply(n.classList, e.split(/\s+/)) : n.className = n.className
            .replace(new RegExp('(\\s|^)' + e + '(\\s|$)'), ' ').replace(/^\s+|\s+$/g, ''))
        }
        ...
        function _(n, e, t) {
          ...
          for (var i = [], o = t === '*' && e.all ? e.all : e.getElementsByTagName(t), r = o.length; --r >= 0;) {
 p(o[r], n) &&
          i.push(o[r]); 
}
          return i
        ...
        var g = typeof Symbol === 'function' && typeof Symbol.iterator === 'symbol' ? function(n) {
            ...
            return n && typeof Symbol === 'function' && n.constructor === Symbol && n !== Symbol.prototype ? 'symbol'
              : typeof n
          };
          var h = window;
          var v = document;
          var m = 'timeout';
          var y = !!v.documentElement.classList;
          var b = 1e10 * Math.random() >>> 0;
          var k = function(n, e) {
          ...
          var A = function(n) {
            for (var e = n.offsetLeft, t = n.offsetParent; t !== null;) e += t.offsetLeft, t = t.offsetParent;
            return e
          };
          var T = function(n) {
            for (var e = n.offsetTop, t = n.offsetParent; t !== null;) e += t.offsetTop, t = t.offsetParent;
            return e
          };
        n.exports = {
          addClass: i,
        ...
        function i(n) {
          return this instanceof i ? (this._state = l, this._onFulfilled = [], this._onRejected = [], this._value = null,
            this._reason = null, void (d(n) && n(a(this.resolve, this), a(this.reject, this)))) : new i(n)
        }
 ...
 try {
        ...
        function i(n, e, t) {
          if (n) {
            var i = 0;
              var o = n.length;
            if (o === +o) { for (; i < o && e.call(t, n[i], i, n) !== !1; i++); } else {
 for (i in n) { if (n.hasOwnProperty(i) && e.call(t, n[i], i, n) === !1) break } 
}
          }
        }
        ...
        function a(n, e) {
          e && o(n, e) && (n.classList ? n.classList.remove.apply(n.classList, e.split(/\s+/)) : n.className = n.className
            .replace(new RegExp('(\\s|^)' + e + '(\\s|$)'), ' ').replace(/^\s+|\s+$/g, ''))
        }
        ...
        e.each = i, e.hasClass = o, e.addClass = r, e.removeClass = a, e.toggleClass = function(n, e) {
          ...
          for (var i = [], r = t === '*' && e.all ? e.all : e.getElementsByTagName(t), a = r.length; --a >= 0;) {
 o(r[a], n) &&
          i.push(r[a]); 
}
          return i
          ...
          t = t || 7;
          var i = new Date();
          i.setTime(i.getTime() + 864e5 * t), document.cookie = [encodeURIComponent(n), '=', encodeURIComponent('' + e),
        ...
        e.isIEX = function(n) {
          ...
          return e.innerHTML = '<!--[if IE ' + n + ']><i></i><![endif]-->', _[n] = e.getElementsByTagName('i').length === 1
        };
        var s = e.getElementLeft = function(n) {
            for (var e = n.offsetLeft, t = n.offsetParent; t !== null;) e += t.offsetLeft, t = t.offsetParent;
            return e
          };
          var l = e.getElementTop = function(n) {
            for (var e = n.offsetTop, t = n.offsetParent; t !== null;) e += t.offsetTop, t = t.offsetParent;
            return e
          };
        ...
        var o = (t(4).URL_MAP, '//cf.aliyun.com/scratchCardSlide/dataReport.jsonp');
          var r = window;
        e.log = function(n, e) {
          var t; var r; var a = e || o;
            var c = ['a', 't', 'scene', 'ns', 'jsv', 'usa', 'p', 'jsType', 'os', 'em', 'ec'];
            var s = [];
            var l = c.length;
 ...
 if (l[f].src.indexOf('ncpc/nc.js') != -1) {
        ...
        d = u.indexOf('g.alicdn.com') != -1 ? 'https://g.alicdn.com/AWSC/AWSC/awsc.js'
        ...
        n.exports = function() {
          ...
          return n.toString = function() {
            ...
            for (var i = {}, o = 0; o < this.length; o++) {
              var r = this[o][0];
              typeof r === 'number' && (i[r] = !0)
            }
            for (o = 0; o < e.length; o++) {
              var a = e[o];
              typeof a[0] === 'number' && i[a[0]] || (t && !a[2] ? a[2] = t : t && (a[2] = '(' + a[2] + ') and (' + t + ')'),
                n.push(a))
            }
          }, n
        }
        ...
        function o(n, e) {
          var t = g();
            var i = m[m.length - 1];
          if (n.insertAt === 'top') {
 i ? i.nextSibling ? t.insertBefore(e, i.nextSibling) : t.appendChild(e) : t.insertBefore(
            e, t.firstChild), m.push(e); 
} else {
            if (n.insertAt !== 'bottom') {
 throw new Error(
 ...
 n.sourceMap && typeof URL === 'function' && typeof URL.createObjectURL === 'function' && typeof URL.revokeObjectURL ===
          'function' && typeof Blob === 'function' && typeof btoa === 'function' ? (t = c(e), i = f.bind(
            null, t), o = function() {
        ...
        var d = {};
          var p = function(n) {
            var e;
            return function() {
              return typeof e === 'undefined' && (e = n.apply(this, arguments)), e
            }
          };
          var _ = p(function() {
 ...
 throw new Error(
          ...
          e = e || {}, typeof e.singleton === 'undefined' && (e.singleton = _()), typeof e.insertAt === 'undefined' && (e.insertAt =
            'bottom');
          var o = i(n);
          return t(o, e),
            function(n) {
 ...
 if (o[a].src.indexOf('nch5/index.js') != -1) {
        ...
        c = r.indexOf('g.alicdn.com') != -1 ? 'https://g.alicdn.com/AWSC/AWSC/awsc.js'
          : 'https://aeis.alicdn.com/AWSC/AWSC/awsc.js';
        var s = {
          0: {
 ...
 if (s.hasOwnProperty(l)) {
              u = s[l];
              for (f in u) u.hasOwnProperty(f) && u[f].indexOf('//') === 0 && (u[f] = 'http:' + u[f])
            } 
}
        }
        e.URL_MAP = s
        ...
        !(function() {
          var t = {
            ...
            ASYNC: 'async',
            create: function(n, e) {
              var i = typeof n.initial === 'string' ? {
                  state: n.initial
                } : n.initial;
                var o = n.terminal || n['final'];
                var r = e || n.target || {};
                var a = n.events || [];
                var c = n.callbacks || {};
                var s = {};
 ...
 l[e[i]] = l[e[i]] || [], l[e[i]].push(n.name), s[n.name][e[i]] = n.to ||
                    e[i]; 
}
                  n.to && (l[n.to] = l[n.to] || [])
                };
 ...
 try {
                ...
                return n.error(i, o, r, a, t.Error.INVALID_CALLBACK,
                  'an exception occurred in a caller-provided callback function', c)
              } 
}
            },
            ...
            leaveState: function(n, e, i, o, r) {
              var a = t.leaveThisState(n, e, i, o, r);
                var c = t.leaveAnyState(n, e, i, o, r);
            ...
            buildEvent: function(n, e) {
              return function() {
                var i = this.current;
                  var o = e[i] || (e[t.WILDCARD] != t.WILDCARD ? e[t.WILDCARD] : i) || i;
                  var r = Array.prototype.slice.call(arguments);
                if (this.transition) {
 return this.error(n, i, o, r, t.Error.PENDING_TRANSITION, 'event ' + n +
                  ' inappropriate because previous transition did not complete'); 
}
                if (this.cannot(n)) {
 return this.error(n, i, o, r, t.Error.INVALID_TRANSITION, 'event ' + n +
                  ' inappropriate in current state ' + this.current); 
}
                ...
                this.transition = function() {
                  return a.transition = null, a.current = o, t.enterState(a, n, i, o, r), t.changeState(a, n, i, o, r), t.afterEvent(
                    a, n, i, o, r), t.Result.SUCCEEDED
                }, this.transition.cancel = function() {
                  a.transition = null, t.afterEvent(a, n, i, o, r)
                };
                var c = t.leaveState(this, n, i, o, r);
                return !1 === c ? (this.transition = null, t.Result.CANCELLED) : t.ASYNC === c ? t.Result.PENDING : this.transition
                  ? this.transition() : void 0
              }
            }
          };
          typeof n !== 'undefined' && n.exports && (e = n.exports = t), e.StateMachine = t
        }())
      }, function(n, e, t) {
        'use strict';
        var i = '//cf.aliyun.com';
        n.exports = {
          ...
          default_options: {
            language: 'cn',
            objects: ['//img.alicdn.com/tfs/TB1NYk7SFXXXXcWaXXXXXXXXXXX-57-69.png',
              '//img.alicdn.com/tfs/TB12q8sSVXXXXcSXFXXXXXXXXXX-57-67.png'
            ],
            elements: ['//img.alicdn.com/tfs/TB1NYk7SFXXXXcWaXXXXXXXXXXX-57-69.png',
              '//img.alicdn.com/tfs/TB12q8sSVXXXXcSXFXXXXXXXXXX-57-67.png'
            ],
            obj_ok: '//img.alicdn.com/tfs/TB1OLQ7SFXXXXaoapXXXXXXXXXX-57-70.png',
            obj_fail: '//img.alicdn.com/tfs/TB1N4lDSVXXXXcFXpXXXXXXXXXX-57-66.png',
        ...
        function i(n, e) {
          var t; var i; var r = e ? {} : n;
          for (t in n) {
 n.hasOwnProperty(t) && (i = n[t], typeof i === 'string' && (i = [i]), r[t] =
            '<view class="nc-lang-cnt" data-nc-lang="' + t + '">' + o(d[t], i) + '</view>'); 
}
          return r
        }
        ...
        var s; var l = 'javascript:NoCaptcha.reset()';
          var u = 'https://survey.taobao.com/survey/AMnMVgrS4?type=%TYPE&str=%STR';
          var f = '{0}';
          var d = {
            _ggk_guide: '{0}',
            _ggk_start: f,
          ...
          var p = {
            cn: {
              ...
              _ggk_start: '',
              _ggk_net_err: ['\u7f51\u7edc\u5b9e\u5728\u4e0d\u7ed9\u529b<br/>\u8bf7', l, '\u518d\u6765\u4e00\u6b21',
                '\u6216', u, '\u53cd\u9988\u95ee\u9898'
              ],
              _ggk_too_fast: ['\u60a8\u522e\u5f97\u592a\u5feb\u5566<br/>\u8bf7', l, '\u518d\u6765\u4e00\u6b21', '\u6216', u,
                '\u53cd\u9988\u95ee\u9898'
              ],
              _ggk_action_timeout: ['\u6211\u7b49\u5f97\u592a\u4e45\u5566<br/>\u8bf7', l, '\u518d\u6765\u4e00\u6b21',
                '\u6216', u, '\u53cd\u9988\u95ee\u9898'
              ],
              _ggk_fail: ['\u5440\uff0c\u5c0f\u9e21\u9003\u8dd1\u4e86<br/>\u8bf7', l, '\u518d\u6765\u4e00\u6b21', '\u6216',
                u, '\u53cd\u9988\u95ee\u9898'
              ],
              _ggk_loading: '\u52a0\u8f7d\u4e2d',
            ...
            tw: {
              ...
              _ggk_start: '',
              _ggk_net_err: ['\u7db2\u8def\u5be6\u5728\u4e0d\u7d66\u529b<br/>\u8acb', l, '\u518d\u6765\u4e00\u6b21',
                '\u6216', u, '\u53cd\u6620\u554f\u984c'
              ],
              _ggk_too_fast: ['\u60a8\u522e\u5f97\u592a\u5feb\u5566<br/>\u8acb', l, '\u518d\u6765\u4e00\u6b21', '\u6216', u,
                '\u53cd\u6620\u554f\u984c'
              ],
              _ggk_action_timeout: ['\u6211\u7b49\u5f97\u592a\u4e45\u5566<br/>\u8acb', l, '\u518d\u6765\u4e00\u6b21',
                '\u6216', u, '\u53cd\u6620\u554f\u984c'
              ],
              _ggk_fail: ['\u5440\uff0c\u5c0f\u96de\u9003\u8dd1\u4e86<br/>\u8acb', l, '\u518d\u6765\u4e00\u6b21', '\u6216',
                u, '\u53cd\u6620\u554f\u984c'
              ],
              _ggk_loading: '\u52a0\u8f09\u4e2d',
            ...
            en: {
              ...
              _ggk_action_timeout: ["You've been idled for too long<br/>Please", l, 'try again', 'or', u,
                'report your problem'
              ],
            ...
            es_ES: {
              ...
              _ggk_too_fast: ['\xa1Has sido demasiado r\xe1pido.', l, 'Vuelve a intentarlo ', 'o', u,
            ...
            pl_PL: {
              ...
              _ggk_start: '',
              _ggk_net_err: ['Problem z sieci\u0105.', l, 'Spr\xf3buj ponownie ', 'lub', u,
                ' zg\u0142o\u015b sw\xf3j problem'
              ],
              _ggk_too_fast: ['Za szybko.', l, 'Spr\xf3buj ponownie ', 'lub', u, ' zg\u0142o\u015b sw\xf3j problem'],
              _ggk_action_timeout: ['Bezczynno\u015b\u0107 trwa\u0142a zbyt d\u0142ugo.', l, 'Spr\xf3buj ponownie ', 'lub',
                u, ' zg\u0142o\u015b sw\xf3j problem'
              ],
              _ggk_fail: ['Ups, kurczaki uciek\u0142y.', l, 'Spr\xf3buj ponownie ', 'lub', u,
                ' zg\u0142o\u015b sw\xf3j problem'
              ],
              _ggk_loading: '\u0141aduj\u0119',
            ...
            fr_FR: {
              ...
              _ggk_start: '',
              _ggk_net_err: ['Probl\xe8me de r\xe9seau.', l, 'Veuillez r\xe9essayer ', 'ou', u,
                ' signaler votre probl\xe8me'
              ],
              _ggk_too_fast: ['Vous avez \xe9t\xe9 trop rapide.', l, 'Veuillez r\xe9essayer ', 'ou', u,
                ' signaler votre probl\xe8me'
              ],
              _ggk_action_timeout: ["D\xe9lai d'attente d\xe9pass\xe9.", l, 'Veuillez r\xe9essayer ', 'ou', u,
                ' signaler votre probl\xe8me'
              ],
              _ggk_fail: ['Oups, les poulets se sont enfuit.', l, 'Veuillez r\xe9essayer ', 'ou', u,
                ' signaler votre probl\xe8me'
              ],
            ...
            de_DE: {
              ...
              _ggk_action_timeout: ['Zeit\xfcberschreitung, bitte.', l, 'versuchen Sie es erneut ', 'oder', u,
                ' melden Sie ein Problem'
              ],
              _ggk_fail: ['Hoppla, die H\xfchner sind davongelaufen.', l, 'versuchen Sie es erneut ', 'oder', u,
                ' melden Sie ein Problem'
              ],
              _ggk_loading: 'Lade',
            ...
            ru_RU: {
              ...
              _ggk_too_fast: ['\u0421\u043b\u0438\u0448\u043a\u043e\u043c \u0431\u044b\u0441\u0442\u0440\u043e.', l,
                '\u041f\u043e\u0432\u0442\u043e\u0440\u0438\u0442\u0435 \u043f\u043e\u043f\u044b\u0442\u043a\u0443 ',
                '\u0438\u043b\u0438', u,
                ' \u0441\u043e\u043e\u0431\u0449\u0438\u0442\u0435 \u043e \u043f\u0440\u043e\u0431\u043b\u0435\u043c\u0435'
              ],
              _ggk_action_timeout: ['\u0412\u0440\u0435\u043c\u044f \u0438\u0441\u0442\u0435\u043a\u043b\u043e.', l,
                '\u041f\u043e\u0432\u0442\u043e\u0440\u0438\u0442\u0435 \u043f\u043e\u043f\u044b\u0442\u043a\u0443 ',
                '\u0438\u043b\u0438', u,
                ' \u0441\u043e\u043e\u0431\u0449\u0438\u0442\u0435 \u043e \u043f\u0440\u043e\u0431\u043b\u0435\u043c\u0435'
              ],
              _ggk_fail: [
                '\u041e\u0439, \u0446\u044b\u043f\u043b\u044f\u0442\u0430 \u0443\u0431\u0435\u0436\u0430\u043b\u0438.', l,
                '\u041f\u043e\u0432\u0442\u043e\u0440\u0438\u0442\u0435 \u043f\u043e\u043f\u044b\u0442\u043a\u0443 ',
                '\u0438\u043b\u0438', u,
                ' \u0441\u043e\u043e\u0431\u0449\u0438\u0442\u0435 \u043e \u043f\u0440\u043e\u0431\u043b\u0435\u043c\u0435'
              ],
            ...
            ja_JP: {
              ...
              _ggk_start: '',
              _ggk_net_err: ['\u30cd\u30c3\u30c8\u30ef\u30fc\u30af\u306b\u554f\u984c\u304c\u3042\u308a\u307e\u3059.', l,
                '\u518d\u8a66\u884c ', '\u3059\u308b\u304b', u,
                ' \u554f\u984c\u3092\u5831\u544a\u3057\u3066\u304f\u3060\u3055\u3044'
              ],
              _ggk_too_fast: ['\u901f\u3059\u304e\u307e\u3059.', l, '\u518d\u8a66\u884c ', '\u3059\u308b\u304b', u,
                ' \u554f\u984c\u3092\u5831\u544a\u3057\u3066\u304f\u3060\u3055\u3044'
              ],
              _ggk_action_timeout: ['\u30bf\u30a4\u30e0\u30a2\u30a6\u30c8.', l, '\u518d\u8a66\u884c ', '\u3059\u308b\u304b',
                u, ' \u554f\u984c\u3092\u5831\u544a\u3057\u3066\u304f\u3060\u3055\u3044'
              ],
              _ggk_fail: [
                '\u304a\u3063\u3068\u3001\u30cb\u30ef\u30c8\u30ea\u304c\u9003\u3052\u3066\u3057\u307e\u3044\u307e\u3057\u305f.',
            ...
            ko_KR: {
              ...
              _ggk_start: '',
              _ggk_net_err: ['\ub124\ud2b8\uc6cc\ud06c\uc5d0 \ubb38\uc81c\uac00 \uc788\uc2b5\ub2c8\ub2e4\u3059.', l,
                '\ub2e4\uc2dc \uc2dc\ub3c4\ud558\uc2dc ', '\uac70\ub098', u,
                ' \ubb38\uc81c\ub97c \ubcf4\uace0\ud574 \uc8fc\uc138\uc694'
              ],
              _ggk_too_fast: ['\ub108\ubb34 \ube60\ub985\ub2c8\ub2e4.', l, '\ub2e4\uc2dc \uc2dc\ub3c4\ud558\uc2dc ',
                '\uac70\ub098', u, ' \ubb38\uc81c\ub97c \ubcf4\uace0\ud574 \uc8fc\uc138\uc694'
              ],
              _ggk_action_timeout: ['\uc2dc\uac04\uc774 \ucd08\uacfc\ub418\uc5c8\uc2b5\ub2c8\ub2e4.', l,
                '\ub2e4\uc2dc \uc2dc\ub3c4\ud558\uc2dc ', '\uac70\ub098', u,
                ' \ubb38\uc81c\ub97c \ubcf4\uace0\ud574 \uc8fc\uc138\uc694'
              ],
              _ggk_fail: ['\uc774\ub7f0, \ub2ed\uc774 \ub2ec\uc544\ub0ac\uc2b5\ub2c8\ub2e4.', l,
                '\ub2e4\uc2dc \uc2dc\ub3c4\ud558\uc2dc ', '\uac70\ub098', u,
                ' \ubb38\uc81c\ub97c \ubcf4\uace0\ud574 \uc8fc\uc138\uc694'
              ],
              _ggk_loading: '\ub85c\ub529',
            ...
            tr_TR: {
              ...
              _ggk_start: '',
              _ggk_net_err: ['A\u011fla ilgili bir sorun. L\xfctfen.', l, 'tekrar deneyin ', 'veya', u,
                ' sorununuzu bildirin'
              ],
              _ggk_too_fast: ['Fazla h\u0131zl\u0131yd\u0131n\u0131z. L\xfctfen.', l, 'tekrar deneyin ', 'veya', u,
                ' sorununuzu bildirin'
              ],
              _ggk_action_timeout: ['S\xfcre doldu, l\xfctfen.', l, 'tekrar deneyin ', 'veya', u, ' sorununuzu bildirin'],
              _ggk_fail: ['T\xfch, tavuklar ka\xe7t\u0131. L\xfctfen.', l, 'tekrar deneyin ', 'veya', u,
                ' sorununuzu bildirin'
              ],
            ...
            th_TH: {
              ...
              _ggk_too_fast: ['\u0e04\u0e38\u0e13\u0e17\u0e33\u0e40\u0e23\u0e47\u0e27\u0e40\u0e01\u0e34\u0e19\u0e44\u0e1b.',
                l, '\u0e42\u0e1b\u0e23\u0e14\u0e25\u0e2d\u0e07\u0e2d\u0e35\u0e01\u0e04\u0e23\u0e31\u0e49\u0e07 ',
                '\u0e2b\u0e23\u0e37\u0e2d', u,
                ' \u0e23\u0e32\u0e22\u0e07\u0e32\u0e19\u0e1b\u0e31\u0e0d\u0e2b\u0e32\u0e02\u0e2d\u0e07\u0e04\u0e38\u0e13'
              ],
              _ggk_action_timeout: ['\u0e2b\u0e21\u0e14\u0e40\u0e27\u0e25\u0e32.', l,
                '\u0e42\u0e1b\u0e23\u0e14\u0e25\u0e2d\u0e07\u0e2d\u0e35\u0e01\u0e04\u0e23\u0e31\u0e49\u0e07 ',
                '\u0e2b\u0e23\u0e37\u0e2d', u,
                ' \u0e23\u0e32\u0e22\u0e07\u0e32\u0e19\u0e1b\u0e31\u0e0d\u0e2b\u0e32\u0e02\u0e2d\u0e07\u0e04\u0e38\u0e13'
              ],
            ...
            vi_VN: {
              ...
              _ggk_start: '',
              _ggk_net_err: ['M\u1ea1ng g\u1eb7p s\u1ef1 c\u1ed1.', l, 'Vui l\xf2ng th\u1eed l\u1ea1i ', 'ho\u1eb7c', u,
                ' b\xe1o c\xe1o s\u1ef1 c\u1ed1 c\u1ee7a b\u1ea1n'
              ],
              _ggk_too_fast: ['B\u1ea1n \u0111\xe3 qu\xe1 nhanh.', l, 'Vui l\xf2ng th\u1eed l\u1ea1i ', 'ho\u1eb7c', u,
                ' b\xe1o c\xe1o s\u1ef1 c\u1ed1 c\u1ee7a b\u1ea1n'
              ],
              _ggk_action_timeout: ['H\u1ebft gi\u1edd.', l, 'Vui l\xf2ng th\u1eed l\u1ea1i ', 'ho\u1eb7c', u,
                ' b\xe1o c\xe1o s\u1ef1 c\u1ed1 c\u1ee7a b\u1ea1n'
              ],
              _ggk_fail: ['R\u1ea5t ti\u1ebfc, l\u0169 g\xe0 \u0111\xe3 ch\u1ea1y \u0111i r\u1ed3i.', l,
                'Vui l\xf2ng th\u1eed l\u1ea1i ', 'ho\u1eb7c', u, ' b\xe1o c\xe1o s\u1ef1 c\u1ed1 c\u1ee7a b\u1ea1n'
              ],
            ...
            iw_HE: {
              ...
              _ggk_start: '',
              _ggk_net_err: ['\u05d3\u05d5\u05d5\u05d7 \u05e2\u05dc \u05d1\u05e2\u05d9\u05d4.', l,
                '\u05d1\u05e2\u05d9\u05d9\u05ea \u05e8\u05e9\u05ea ', '\u05d0\u05d5', u,
                ' \u05d3\u05d5\u05d5\u05d7 \u05e2\u05dc \u05d1\u05e2\u05d9\u05d4'
              ],
              _ggk_too_fast: ['\u05d4\u05d9\u05d9\u05ea \u05de\u05d4\u05d9\u05e8 \u05de\u05d3\u05d9.', l,
                '\u05d1\u05e2\u05d9\u05d9\u05ea \u05e8\u05e9\u05ea ', '\u05d0\u05d5', u,
                ' \u05d3\u05d5\u05d5\u05d7 \u05e2\u05dc \u05d1\u05e2\u05d9\u05d4'
              ],
              _ggk_action_timeout: ['\u05d4\u05d6\u05de\u05df \u05ea\u05dd.', l,
                '\u05d1\u05e2\u05d9\u05d9\u05ea \u05e8\u05e9\u05ea ', '\u05d0\u05d5', u,
                ' \u05d3\u05d5\u05d5\u05d7 \u05e2\u05dc \u05d1\u05e2\u05d9\u05d4'
              ],
              _ggk_fail: [
        ...
        p.zh_CN = p.cn, p.zh_TW = p.tw, p.en_US = p.en, p.iw_IL = p.iw_HE, p.pt_PT = p.pt_BR, p.ar_MA = p.ar_SA, e.language =
          p, e.upLang = r, e.replaceLang = a, e.upResetIndex = c
      }, function(n, e, t) {
        'use strict';
        ...
        function o() {
          a = l.createElement('div'), a.className = 'nc-h5-overlay _nc', a.innerHTML =
            '<view class="info"><i class="nc-iconfont icon-warn"></i><view>' + c('OVERLAY_INFORM') + '</view></view>', l.getElementsByTagName(
            'body')[0].appendChild(a)
        }

        function r(n) {
          var e = l.querySelector('#' + n + '-stage-3');
            var t = l.querySelector('#' + n + '-stage-2');
          t && e && a && (e.parentNode.insertBefore(t, e), a.style.display = 'none'), s = !1
        }
        var a; var c; var s; var l = document;
        n.exports = {
          show: i,
          hide: r,
          setTEXT: function(n) {
        ...
        n.exports = function() {
          ...
          return /Windows/.test(n) ? 'win' : /Macintosh/.test(n) ? 'mac' : /Android/.test(n) ? 'Android'
            : /(iPhone|iPad)/.test(n) ? 'iOS' : /Linux/.test(n) ? 'linux' : 'unknow'
        }
      }, function(n, e, t) {
        'use strict';
        ...
        function i(n) {
          var e; var t = '';
            var i = _.getElementById('umFlash');
          if (i && !t) {
 try {
            e = i.getCookie(n) || '', t = e
          } catch (o) {} 
        ...
        function o(n, e, t) {
          t = t || 7;
          var i = new Date();
          i.setTime(i.getTime() + 864e5 * t), _.cookie = [encodeURIComponent(n), '=', encodeURIComponent('' + e),
            ';expires=', i.toGMTString()
          ].join('')
        }

        function r() {
          var n; var e = /Firefox/.test(navigator.userAgent);
          if (e) {
 try {
        ...
        var u; var f; var d; var p = window;
          var _ = document;
          var g = '_uab_collina';
          var h = p.pointman && pointman._now ? pointman._now : (new Date()).getTime();
        e.getSecToken = c, e.getNCToken = l
      }, , , , , function(n, e, t) {
        e = n.exports = t(8)(), e.push([n.i,
        ...
        function i(n, e, t) {
          ...
          var r; var a = l[n.foreign] || l[0];
          a = s.mix(a, n.apimap), UA_Opt.LogVal = '_n', u.init(n), UA_Opt.sendMethod = 8, UA_Opt.Token = (new Date()).getTime() +
            ':' + n.token, s.loadScript(a.uab_Url, function(n) {
            if (AWSC) {
              var e = function() {
                if (window.__captchah5__uab) {
                  if (clearInterval(t), window.__captchah5__uab === 'timeout') return void i(f);
                  i(n)
                }
              };
              AWSC.use('uab', function(n, e) {
                n === 'loaded' ? window.__captchah5__uab = e : n === 'timeout' && (window.__captchah5__uab = 'timeout')
              });
        ...
        function r(n, e, t) {
          ...
          function o() {
            p ? clearInterval(u) : window.AWSC && (clearInterval(u), window.__captchah5__umidToken =
              'defaultToken1_um_not_loaded@@' + location.href + '@@' + (new Date()).getTime(), window.AWSC.use('um', function(
              e, t) {
              e === 'loaded' ? (window.__captchah5__umidToken = 'defaultToken3_init_callback_not_called@@' + location.href +
                '@@' + (new Date()).getTime(), t.init({
                timeout: n.timeout,
                ...
                n === 'success' ? window.__captchah5__umidToken = e.tn : window.__captchah5__umidToken =
                  'defaultToken4_init_failed with ' + n + '@@' + location.href + '@@' + (new Date()).getTime()
              }), i()) : (window.__captchah5__umidToken = 'defaultToken2_load_failed with ' + e + '@@' + location.href +
                '@@' + (new Date()).getTime(), i(f))
            }))
          }
          var r = void 0;
        ...
        function a() {
          function n() {
            (t || window.__captchah5__umidToken.indexOf('defaultToken')) && c.__acjs ? clearInterval(i) : e++ > 100 &&
              clearInterval(i)
          }
          if (!d) {
            d = !0;
        ...
        e.init = function(n, e) {
          ...
          n.onenterts_verifying = function() {
            ...
            s.disabled = !0;
            var l = e.options;
            t('.icon.clear').style.display = 'none', t('.icon.refresh').style.display = 'none', c.postCaptcha(a, i,
              function(e, t, i) {
                var r = e === 'ok' && t && t.success && t.result.code === 100;
                  var a = t && t.result || {};
                a.csessionid = i, r ? n.ts_verifypass(a) : (o++, e === 'timeout' ? (n.ts_verifyerror(a), o = 0) : typeof l.errorTimes ===
                'number' && o >= l.errorTimes ? (n.ts_verifyerror(a), o = 0) : n.ts_verifyfail(a))
              })
        ...
        e.init = function(n) {
          var e = n.fsm;
            var t = i.mix({}, o.default_options, n.options || {});
        ...
        'use strict';
        e.init = function(n) {
          window.__captchah5_uaboption = new Object(), n.is_Opt ? (UA_Opt.MPInterval = typeof UA_Opt.MPInterval !== 'undefined' &&
          UA_Opt.MPInterval > 0 ? UA_Opt.MPInterval : 4, UA_Opt.MaxMCLog = typeof UA_Opt.MaxMCLog !== 'undefined' &&
          UA_Opt.MaxMCLog > 0 ? UA_Opt.MaxMCLog : 12, UA_Opt.MaxKSLog = typeof UA_Opt.MaxKSLog !== 'undefined' && UA_Opt
            .MaxKSLog > 0 ? UA_Opt.MaxKSLog : 14, UA_Opt.MaxMPLog = typeof UA_Opt.MaxMPLog !== 'undefined' && UA_Opt.MaxMPLog >
          0 ? UA_Opt.MaxMPLog : 5, UA_Opt.MaxFocusLog = typeof UA_Opt.MaxFocusLog !== 'undefined' && UA_Opt.MaxFocusLog >
          0 ? UA_Opt.MaxFocusLog : 6, UA_Opt.SendInterval = typeof UA_Opt.SendInterval !== 'undefined' && UA_Opt.SendInterval >
          0 ? UA_Opt.SendInterval : 5, UA_Opt.SendMethod = typeof UA_Opt.SendMethod !== 'undefined' && UA_Opt.SendMethod >
          0 ? UA_Opt.SendMethod : 8, UA_Opt.GPInterval = typeof UA_Opt.GPInterval !== 'undefined' && UA_Opt.GPInterval >
          0 ? UA_Opt.GPInterval : 1, UA_Opt.MaxGPLog = typeof UA_Opt.MaxGPLog !== 'undefined' && UA_Opt.MaxGPLog > 0
            ? UA_Opt.MaxGPLog : 10, UA_Opt.MaxTCLog = typeof UA_Opt.MaxTCLog !== 'undefined' && UA_Opt.MaxTCLog > 0 ? UA_Opt
            .MaxTCLog : 12, UA_Opt.Flag = typeof UA_Opt.Flag !== 'undefined' && UA_Opt.Flag > 0 ? UA_Opt.Flag : 2980046,
            UA_Opt.OnlyHost = typeof UA_Opt.OnlyHost !== 'undefined' ? UA_Opt.OnlyHost : 1, window.__captchah5_uaboption.MPInterval =
            typeof UA_Opt.MPInterval !== 'undefined' && UA_Opt.MPInterval > 0 ? UA_Opt.MPInterval : 4, window.__captchah5_uaboption
            .MaxMCLog = typeof UA_Opt.MaxMCLog !== 'undefined' && UA_Opt.MaxMCLog > 0 ? UA_Opt.MaxMCLog : 12, window.__captchah5_uaboption
            .MaxKSLog = typeof UA_Opt.MaxKSLog !== 'undefined' && UA_Opt.MaxKSLog > 0 ? UA_Opt.MaxKSLog : 14, window.__captchah5_uaboption
            .MaxMPLog = typeof UA_Opt.MaxMPLog !== 'undefined' && UA_Opt.MaxMPLog > 0 ? UA_Opt.MaxMPLog : 5, window.__captchah5_uaboption
            .MaxFocusLog = typeof UA_Opt.MaxFocusLog !== 'undefined' && UA_Opt.MaxFocusLog > 0 ? UA_Opt.MaxFocusLog : 6,
            window.__captchah5_uaboption.SendInterval = typeof UA_Opt.SendInterval !== 'undefined' && UA_Opt.SendInterval >
            0 ? UA_Opt.SendInterval : 5, window.__captchah5_uaboption.SendMethod = typeof UA_Opt.SendMethod !== 'undefined' &&
          UA_Opt.SendMethod > 0 ? UA_Opt.SendMethod : 8, window.__captchah5_uaboption.GPInterval = typeof UA_Opt.GPInterval !==
          'undefined' && UA_Opt.GPInterval > 0 ? UA_Opt.GPInterval : 1, window.__captchah5_uaboption.MaxGPLog =
            typeof UA_Opt.MaxGPLog !== 'undefined' && UA_Opt.MaxGPLog > 0 ? UA_Opt.MaxGPLog : 10, window.__captchah5_uaboption
            .MaxTCLog = typeof UA_Opt.MaxTCLog !== 'undefined' && UA_Opt.MaxTCLog > 0 ? UA_Opt.MaxTCLog : 12, window.__captchah5_uaboption
            .Flag = typeof UA_Opt.Flag !== 'undefined' && UA_Opt.Flag > 0 ? UA_Opt.Flag : 2980046, window.__captchah5_uaboption
            .OnlyHost = typeof UA_Opt.OnlyHost !== 'undefined' ? UA_Opt.OnlyHost : 1, window.__captchah5_uaboption.MaxMTLog =
            typeof UA_Opt.MaxMTLog !== 'undefined' ? UA_Opt.MaxMTLog : 300, window.__captchah5_uaboption.MinMTDwnLog =
            typeof UA_Opt.MinMTDwnLog !== 'undefined' ? UA_Opt.MinMTDwnLog : 30, window.__captchah5_uaboption.MaxNGPLog =
            typeof UA_Opt.MaxNGPLog !== 'undefined' ? UA_Opt.MaxNGPLog : 200, window.__captchah5_uaboption.sIDs =
            typeof UA_Opt.sIDs !== 'undefined' ? UA_Opt.sIDs : ['_n1t|_n1z|nocaptcha|-stage-1'], window.__captchah5_uaboption
            .mIDs = typeof UA_Opt.mIDs !== 'undefined' ? UA_Opt.mIDs : ['nc-canvas', 'click2slide-btn'], window.__captchah5_uaboption
            .hook = typeof UA_Opt.hook !== 'undefined' ? UA_Opt.hook : 1, window.__captchah5_uaboption.font = typeof UA_Opt.font !==
          'undefined' ? UA_Opt.font : 1, window.__captchah5_uaboption.api = typeof UA_Opt.api !== 'undefined'
            ? UA_Opt.api : 1) : (UA_Opt.SendInterval = 5, UA_Opt.SendMethod = 8, UA_Opt.MaxMCLog = 12, UA_Opt.MaxKSLog = 14,
            UA_Opt.MaxMPLog = 5, UA_Opt.MaxGPLog = 10, UA_Opt.MaxTCLog = 12, UA_Opt.GPInterval = 1, UA_Opt.MPInterval = 4,
            UA_Opt.MaxFocusLog = 6, UA_Opt.isSendError = 1, UA_Opt.Flag = 2980046, UA_Opt.OnlyHost = 1, window.__captchah5_uaboption
            .SendInterval = 5, window.__captchah5_uaboption.SendMethod = 8, window.__captchah5_uaboption.MaxMCLog = 12,
            window.__captchah5_uaboption.MaxKSLog = 14, window.__captchah5_uaboption.MaxMPLog = 5, window.__captchah5_uaboption
            .MaxGPLog = 10, window.__captchah5_uaboption.MaxTCLog = 12, window.__captchah5_uaboption.GPInterval = 1,
            window.__captchah5_uaboption.MPInterval = 4, window.__captchah5_uaboption.MaxFocusLog = 6, window.__captchah5_uaboption
            .isSendError = 1, window.__captchah5_uaboption.Flag = 2980046, window.__captchah5_uaboption.OnlyHost = 1,
            window.__captchah5_uaboption.MaxMTLog = 300, window.__captchah5_uaboption.MinMTDwnLog = 30,
            window.__captchah5_uaboption.MaxNGPLog = 200, window.__captchah5_uaboption.sIDs = [
            '_n1t|_n1z|nocaptcha|-stage-1'
          ], window.__captchah5_uaboption.mIDs = ['nc-canvas', 'click2slide-btn'], window.__captchah5_uaboption.hook =
            1, window.__captchah5_uaboption.font = 1, window.__captchah5_uaboption.api = 1), window.__captchah5_uaboption
            .Flag |= 2097152
        }
      }, , , , , , , , , , , , , , , , , , , , , , function(n, e, t) {
        'use strict';
        ...
        function i(n) {
          return n.type === 'scrape'
        }
        var o = t(76);
          var r = t(77);
          var a = ['on', 'setEnabled', 'reset', 'show', 'hide', 'getState'];
          var c = {
            index: 0,
            js_type: 'h5',
            v: t(6).v
        ...
        e.makeNC = function() {
          ...
          n.prototype = {
            init: function(n) {
              return this.__initialized ? void (win.console && win.console.warn('[nch5] Current NC(' + this.nc_obj.prefix +
                ') is already initialized!')) : (this.nc_obj.init(n), void (this.__initialized = 1))
            }
          }, t(75);
          var e = t(11);
          return n.upLang = e.upLang, n.init = function(e) {
            var t;
            if (e.upLang) { for (var a in e.upLang) n.upLang(a, e.upLang[a]); }
 ...
 t.styleSheet.disabled || (t.styleSheet.cssText =
            e); 
} else {
 try {
            t.innerHTML = e
        ...
        i.prototype = {
          init: function(n) {
            n.token = n.token || u.getNCToken(), n.foreign = n.foreign || '0', n.umidServer = n.umidServer || 'r', n.retryTimes =
              parseInt(n.retryTimes), n.apimap = n.apimap || {}, (typeof n.retryTimes !== 'number' || isNaN(n.retryTimes)) &&
            (n.retryTimes = 5), this.options = n, this.fsm = t(82).makeFSM(this), this.net = t(83).makeNet(this.fsm,
              this), this.net.initialize(), s++, this.prefix = this.options.prefix || 'nc_' + s, this.container = r.querySelector(
              this.options.renderTo), this.fsm.init(), n.initHidden && this.hide()
          },
          getState: function() {
          ...
          fire: function(n) {
            var e; var t; var i = this.event_listeners[n];
            if (i) { for (e = 0, t = i.length; e < t && i[e].call() !== !1; e++); }
          },
          ...
          _reset: function() {
            this.container && (this.container.style.display = 'block'), this.options.appkey && this.options.token && (
              UA_Opt.LogVal = '_n', a.init(this.options), UA_Opt.Token = (new Date()).getTime() + ':' + this.options.token,
        ...
        var o = (function() {
          ...
          var f = (function() {
            function n(e, t) {
              i(this, n);
              var o = 'cn';
              e.foreign && (o = 'en'), this.options = c.mix({}, o, e), this.inn_vars = t, t.index++, this.index = t.index,
                this.jsv = t.v, this.el = document.getElementById(e.renderTo.replace(/^#/, '')), this.el || a.fail(
                "'renderTo'(" + e.renderTo + ') does not match any node.'), this.makeFSM(), this.initStates(), this.event_listeners = {},
            ...
            return o(n, [{
              ...
              key: 'fire',
              value: function(n) {
                for (var e = this.event_listeners[n] = this.event_listeners[n] || [], t = 0; t < e.length && e[t].call() !==
                !1; t++);
              }
            }, {
              key: 'reload',
              ...
              value: function(n, e, t) {
                var i = this.options;
                  var o = i.token || UA_Opt.Token || (typeof umx !== 'undefined' && umx.getToken ? umx.getToken() : '');
                s.log({
                  a: i.appkey,
                  t: o,
                  scene: i.scene,
        ...
        e.makeClickSlider = function(n) {
          ...
          function a(e) {
            w = e, c(), p.innerHTML = o.trans(n.options.language, 'LOADING'), n.on('ready', function() {
              t('nc-iconfont icon-notclick'), p.innerHTML = '<view class="nc-iconfont icon-left-triangle"></view>' + o.trans(
                n.options.language, 'CLICK_LABEL_READY')
          ...
          function s() {
            k || (t('nc-iconfont icon-onclick'), p.style.display = 'none', h.style.display = 'block', n.fire('actionstart'),
              l(), t('nc-iconfont icon-load-c nc-loading'), k = !0, setTimeout(function() {
              k = !1
            }, 100))
          }
          ...
          function l() {
            var e = _.getBoundingClientRect();
              var t = _.clientWidth - v.clientWidth;
            y.style.width = e.width + 'px', n.slider.disable(), v.style.left = t + 'px', m.style.width = t + 'px', i.addClass(
              v, 'moving'), i.addClass(m, 'moving')
          }
 ...
 return {
          ...
          var p, _, g, h, v, m, y, b;
          _ = e('.slider-holder .slider'), p = e('.click2slider-label'), g = e('.click2slide-btn'), h = e(
            '.slider-holder'), v = e('.slider .button'), m = e('.slider .track'), y = e('.slider .track div'), b = u().end;
          var k, w;
          return {
            label: p,
            setClickBtnIcon: t,
        ...
        var _slicedToArray = (function() {
          ...
          var html = __webpack_require__(81).html;
          var kvTpl = __webpack_require__(19);
          var util = __webpack_require__(0);
          var cfg = __webpack_require__(14);
          var URL_MAP = __webpack_require__(12).URL_MAP;
          var language = __webpack_require__(15).language;
          var replaceLang = __webpack_require__(15).replaceLang;
          var upResetIndex = __webpack_require__(15).upResetIndex;
          var Promise = __webpack_require__(1);
          var Report = __webpack_require__(3);
          var doc = document;
          var getElementById = function(n) {
            return doc.getElementById(n)
          };
          var styleEl = function(n, e, t) {
            return n.style[e] = t
          };
          var ERR_CODE_API_FAIL = 'SCRAPE_API_FAIL';
          var FAIL_PREPARE = 'fail_prepare';
          var FAIL_ANALYZE = 'fail_analyze';
          var win = window;
        ...
        var obj_w = -1;
          ...
          var Scrape = (function() {
            function Scrape(n) {
              ...
              var t = {};
              if (e.foreign && (t.language = t.language || 'en'), this.options = util.mix({}, cfg.default_options, t, n.options ||
                  {}, e), this._last_x = -1, this._last_y = -1, this.stroke_size = e.stroke_size || cfg.default_stroke_width,
                  this.svr_data = {}, this._t_action = null, this.is_downgraded = !1, this._lang = language[this.options.language] ||
                  language.cn, this.options.upLang) { for (var i in this.options.upLang) this._lang = replaceLang(i, this.options.upLang[i]); }
            ...
            return _createClass(Scrape, [{
              ...
              value: function() {
                var n = this.el_nc_canvas;
                  var e = util.getElementLeft(n);
                  var t = util.getElementTop(n);
                return {
                  x: e,
                  y: t
                }
              ...
              value: function() {
                ...
                return new Promise(function(e, t) {
                  var i = n.options;
                    var o = n.getParamOl();
                    var r = window.__captchah5__uab.getUA && window.__captchah5__uab.getUA(window.__captchah5_uaboption) ||
                      win._n || (UA_Opt.LogVal ? win[UA_Opt.LogVal] : '') || '';
                    var a = r.length > 3 ? r.slice(0, 3) : '';
                  util.jsonp(n.ajaxURL.api_prepare, {
                    ...
                    if (i === 'ok' && (i = ''), i || !o.success) return void t(i || 'data fail');
                    ...
                    a.style.display = 'block', a.innerHTML = n._lang._ggk_start, n.showHow(), n.scrapeStart = !1, util.addClass(
                      n.root, 'nc-prepared'), util.removeClass(n.root, 'nc-state-load-error');
              ...
              value: function() {
                var n = this;
                  var e = this.svr_data;
                  var t = e.objectPoints;
                  var i = t.points;
                if (this._points = i, !i || !Array.isArray(i) || i.length !== t.objectPointsCount) {
 throw new Error(
              ...
              value: function() {
                var n = {
                  ...
                  var e = this.options.hasOwnProperty('width');
                  var t = this.options.hasOwnProperty('height');
                  var i = this.getEl('nc-canvas');
                return this.el_nc_canvas = i, e || (n.width = i.offsetWidth), n.width < cfg.min_width && (n.width = cfg.min_width),
                  styleEl(i, 'width', n.width + 'px'), t || (n.height = i.offsetHeight), n.height < cfg.min_height && (n.height =
                  cfg.min_height), styleEl(i, 'height', n.height + 'px'), n
              }
            }, {
              key: 'render_bg',
              value: function() {
                this.el_bg = this.getEl('bg'), styleEl(this.el_bg, 'width', this.size.width + 'px'), styleEl(this.el_bg,
              ...
              value: function() {
                var n = this;
                  var e = this.getEl('canvas-dg');
                  var t = this.size.width;
                  var i = this.size.height;
                e.style.width = t + 'px', e.style.height = i + 'px', e.style.display = 'block';
                for (var o = cfg.grid_size, r = Math.ceil(t / o), a = Math.ceil(i / o), c = [], s = this.options.bg_back,
                       l = 0; l < a; l++) {
 for (var u = 0; u < r; u++) {
                    var f = o * l;
                      var d = o * u;
                      ...
                      var _ = this.mkGridId(u, l);
                      var g = '<view id="' + _ + '" class="nc-canvas-dg-grid" style="' + util.obj2style(p) + '"></view>';
                    c.push(g)
                  } 
}
                e.innerHTML = c.join('');
              ...
              value: function() {
                ...
                l.src = this.options.bg_front, l.onload = function() {
                  ...
                  for (var n = l.naturalWidth ? [l.naturalWidth, l.naturalHeight] : [l.width, l.height], e =
                    _slicedToArray(n, 2), o = e[0], r = e[1], a = Math.ceil(i.width / o), c = Math.ceil(i.height / r), s =
                    0; s < c; s++) { for (var u = 0; u < a; u++) t.drawImage(l, u * o, s * r); }
              ...
              value: function(n) {
                var e = doc.documentElement.scrollLeft || doc.body.scrollLeft;
                  ...
                  var i = this.options.renderTo;
                  var o = getElementById(i.indexOf('#') === 0 ? i.slice(1) : i);
                  var r = 0;
                  var a = 0;
                o.style.position == 'absolute' && (r = o.offsetLeft, a = o.offsetTop);
                var c = (n.clientX + e || n.pageX) - (r + this.offsetX || 0);
                  var s = (n.clientY + t || n.pageY) - (a + this.offsetY || 0);
                return [c, s]
              }
            }, {
              key: '_clearTo_dg',
              value: function(n, e) {
                var t = Math.floor(n / cfg.grid_size);
                  var i = Math.floor(e / cfg.grid_size);
                  var o = this.mkGridId(t, i);
              ...
              value: function(n, e) {
                ...
                var t = this.ctx;
                t.fillStyle = '#fff', t.beginPath(), t.arc(n, e, this.stroke_size / 2, 0, 2 * Math.PI), t.fill(), this._last_x >=
                0 && this._last_y >= 0 && (t.beginPath(), t.lineWidth = this.stroke_size, t.moveTo(this._last_x, this._last_y),
                  t.lineTo(n, e), t.stroke()), this._last_x = n, this._last_y = e
              }
            }, {
              key: '_calcRegion',
              value: function(n, e, t, i) {
                for (var o = this.ctx.getImageData(n, e, t, i).data, r = 0, a = 0; a < o.length; a += 4) {
 o[a] && o[a + 1] &&
                o[a + 2] && o[a + 3] && r++; 
}
                return 1 - r / t / i
              ...
              key: '_calcRegion_dg',
              value: function(n, e, t, i) {
                for (var o = cfg.grid_size, r = Math.floor(n / o), a = Math.floor(e / o), c = Math.floor(t / o), s = Math
                  .floor(i / o), l = 0, u = a; u < a + s; u++) {
 for (var f = r; f < r + c; f++) {
              ...
              value: function() {
                var n = this;
                  var e = void 0;
                  var t = void 0;
                  var i = this.matrix.reduce(function(n, e) {
                    return n + e
                  }, 0);
                e = 1 - i / this._grid_sum;
                var o = this.is_downgraded ? 0.7 : 0.9;
                  var r = this.obj_w / 2 * o;
                  var a = this.obj_h / 2 * o;
              ...
              value: function() {
                ...
                var e = this.size;
                  var t = e.width;
                  var i = e.height;
                  var o = this._calcRegion(0, 0, t, i);
                  var r = this.obj_w / 2;
                  var a = this.obj_h / 2;
                  var c = util.map(this._points, function(e) {
                    var t = e.x;
                      var i = e.y;
              ...
              value: function(n, e) {
                ...
                if ((n > 0.9 || t) && window.__captchah5__uab.isReadyForSC(window.__captchah5_uaboption.mIDs) && this.nc.fsm.current ===
                  'ready') this.verify();
                else if (n > 0.9 && t) {
                  try {
                    UA_Opt.sendSA()
              ...
              value: function verifyMethod() {
                ...
                return clearTimeout(this._t_action), new Promise(function(resolve, reject) {
                  ...
                  typeof trans === 'string' && (trans = eval('0,' + trans));
                  ...
                  win._n_bak = win._n, util.jsonp(_this10.ajaxURL.api_analyze, {
                    ...
                    n: window.__captchah5__uab.getUA && window.__captchah5__uab.getUA(window.__captchah5_uaboption) ||
                    win._n || (UA_Opt.LogVal ? win[UA_Opt.LogVal] : '') || '',
                    ...
                    if (e.success && e.result && e.result.success) {
                      ...
                      if (i.code === 0) return _this10.verify_ok(i), void resolve();
                  ...
                  UA_Opt.reload(), window.__captchah5__uab.resetSA(), _this10.nc._err = _this10.nc._err || '4A', _this10
                    .verify_fail()
                })
              }
            }, {
              ...
              value: function(n) {
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [];
                  ...
                  var i = this.options;
                  var o = n;
                  var r = [i.appkey, i.token, i.scene];
                  var a = '';
                switch (n) {
                  case FAIL_PREPARE:
                ...
                switch (o) {
                  case '3A':
                    r = r.concat(e), !t && this.nc._log('ERR_SLIDE_TOO_FAST', 'too few mp', '{code: 201, str:' + r + '}'),
                      a = '201';
                    break;
                  case '4A':
                    e = [this.session_id, win._n_bak], r = r.concat(e), !t && this.nc._log(ERR_CODE_API_FAIL + '_analyze',
                      'blocked', '{code: 101, str:' + r + '}'), a = '101';
                    break;
                  case '5A':
                    e = [this.session_id, win._n_bak], r = r.concat(e), !t && this.nc._log(ERR_CODE_API_FAIL + '_analyze',
                      'blocked', '{code: 301, str:' + r + '}'), a = '301'
                }
              ...
              value: function(n) {
                ...
                return new Promise(function(n, t) {
                  ...
                  var i = function o() {
                    ...
                    e.showEl('load-error'), i = e.size ? e.size.height : r.offsetHeight, t.style.marginTop = (i - 80) /
                      2 + 'px';
              ...
              value: function() {
                ...
                return clearTimeout(this._t_action), Promise.resolve().then(function() {
                  ...
                  typeof t === 'function' && t(n.verify_result)
                })
              }
            }, {
              key: 'getErrIcon',
              ...
              value: function() {
                var n = this.getEl('fail-icon');
                  var e = this.getEl('load-error-icon');
              ...
              value: function(n) {
                ...
                if (this.nc.fsm.current == 'ready') {
                  this.scrapeStart || (this._last_x = -1, this._last_y = -1, this.render_surface()), this.showingHow = !1,
                    this.scrapeStart = !0, this.mousedown = !0, this.getEl('inform').style.display = 'none', this.offsetX =
                    this.el_nc_canvas.offsetLeft, this.offsetY = this.el_nc_canvas.offsetTop;
                  var t = this.getPos(n);
                    var i = _slicedToArray(t, 2);
                    var o = i[0];
                    var r = i[1];
                  this._clearTo(o, r), this._old_onselectstart = doc.body.onselectstart, this._old_ondrag = doc.body.ondrag,
              ...
              value: function(n) {
                ...
                if (this.mousedown) {
                  clearTimeout(this._t_action), this.nc.fsm.current === 'ready' && (this._t_action = setTimeout(function() {
                    e.actionTimeout()
              ...
              key: 'eventUp',
              value: function() {
                this.mousedown = !1, this._last_x = -1, this._last_y = -1, this.is_downgraded && (doc.body.onselectstart =
                  this._old_onselectstart, doc.body.ondrag = this._old_ondrag), this._old_onselectstart = null, this._old_ondrag =
                  null
              }
            }, {
              key: 'mkMatrix',
              ...
              value: function() {
                var n = this;
                  var e = this.getEl('btn-refresh');
                  var t = this.getEl('btn-info');
              ...
              value: function() {
                if (!this.showingHow && !this.scrapeStart) {
                  ...
                  var a = this;
                    var c = function s() {
                      return a.scrapeStart ? void (n.style.display = 'none') : (a.showingHow = !0, void (i < r ? (n.style.left =
                        e[i][0] + 'px', n.style.top = e[i][1] + 5 + 'px', i == 0 && a.render_surface(), a._clearTo(e[i][0] +
                        20, e[i][1] + 5), i++, setTimeout(s, 10)) : (o++, o < t ? (a._last_x = -1, a._last_y = -1, i = 0,
                        setTimeout(s, 500)) : (a._last_x = -1, a._last_y = -1, n.style.display = 'none', a.render_surface(),
                        a.showingHow = !1))))
                    };
                  c()
                }
                ...
                return new Promise(function(e, t) {
                  try {
                    ...
                    if (n.root.innerHTML = kvTpl.render(html, {
                      ...
                      }), n.showEl('loading'), n.hideEl('load-error'), n.getEl('title').innerHTML = n._lang._ggk_guide, n.bindEvents(),
                        n.size = n.getSize(), n.getEl('container').style.width = n.size.width + 'px', n.render_bg(), n.el_canvas =
                        n.getEl('canvas'), !n.el_canvas.getContext || !(n.ctx = n.el_canvas.getContext('2d'))) {
 return n.downgrade(),
                      n.render_surface_dg(), void e(); 
}
                    n.render_surface(), e()
                  } catch (o) {
                    t(o)
              ...
              value: function() {
                var n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : function() {
                  ...
                  var e = this.loading_sendInitReq();
                e.then(n)['catch'](n)
              }
            }]), Scrape
          }());
        ...
        'use strict';
        e.html =
          '<view id="{{prefix}}container" class="nc-container nc-scrape"><view id="{{prefix}}for-tmp" class="nc-for-tmp"></view><view id="{{prefix}}toolbar" class="nc-toolbar"><view id="{{prefix}}title" class="nc-title">{{title}}</view> <view class="nc-btns"><i id="{{prefix}}btn-refresh" class="nc_iconfont icon_refresh">&#xe607;</i> <i id="{{prefix}}btn-info" class="nc_iconfont icon_info">&#xe602;</i></view></view><view id="{{prefix}}nc-canvas" class="nc-canvas"><view id="{{prefix}}bg" class="nc-bg"></view><view id="{{prefix}}cover" class="nc-cover"><canvas id="{{prefix}}canvas" class="nc-canvas-node"></canvas><view id="{{prefix}}canvas-dg" class="nc-canvas-dg" unselectable="on" style="-moz-user-select:none;-webkit-user-select:none" onselectstart="return false"></view><view id="{{prefix}}ok" class="nc-verify-ok"><img src="{{obj_ok}}" alt=""><view><i class="nch5_iconfont icon_success">&#xe686;</i><view id="{{prefix}}ok-msg"></view></view></view><view id="{{prefix}}fail" class="nc-verify-fail"><img id="{{prefix}}fail-icon" src="{{obj_error}}" alt=""><view><i class="nch5_iconfont icon_error">&#xe604;</i><view id="{{prefix}}fail-msg"></view></view></view><view id="{{prefix}}loading" class="nc-loading"><view id="nc-loading-circle" class="nc-loading-circle"><view class="sk-circle1 sk-circle"></view><view class="sk-circle2 sk-circle"></view><view class="sk-circle3 sk-circle"></view><view class="sk-circle4 sk-circle"></view><view class="sk-circle5 sk-circle"></view><view class="sk-circle6 sk-circle"></view><view class="sk-circle7 sk-circle"></view><view class="sk-circle8 sk-circle"></view><view class="sk-circle9 sk-circle"></view><view class="sk-circle10 sk-circle"></view><view class="sk-circle11 sk-circle"></view><view class="sk-circle12 sk-circle"></view></view><text>{{loading}}</text></view><view id="{{prefix}}inform" class="nc-inform">{{inform}}</view><view id="{{prefix}}load-error" class="nc-load-error"><img id="{{prefix}}load-error-icon" src="{{obj_error}}" alt=""><view><i class="nch5_iconfont icon_error">&#xe604;</i><view id="{{prefix}}load-error-msg">Load Error!</view></view></view></view><view id="{{prefix}}show-how" class="nc-show-how"></view></view></view>'
      }, function(n, e, t) {
        'use strict';
        ...
        e.makeFSM = function(n) {
          var e = i.create({
            ...
            events: [{
              ...
              name: 'reset',
              from: ['ready', 'verifying', 'fail', 'error', 'pass', 'ts_ready', 'ts_verifying', 'ts_fail', 'ts_error',
                'ts_pass'
              ],
              to: 'reseting'
            }, {
          ...
          return e.onleavestate = function(n, e, t) {}, e.onenterstate = function(n, e, t) {}, t(89).init(e, n), t(88).init(
            e, n), t(92).init(e, n), t(99).init(e, n), t(87).init(e, n), t(86).init(e, n), t(91).init(e, n), t(90).init(e,
            n), t(96).init(e, n), t(98).init(e, n), t(29).init(e, n), t(95).init(e, n), t(94).init(e, n), t(97).init(e, n),
            t(93).init(e, n), t(85).init(e, n), e
        }
      }, function(n, e, t) {
        'use strict';
        var i = window;
        ...
        e.makeNet = function(n, e) {
          ...
          function s() {
            var n = {
              ...
              var e = {};
            try {
              navigator.connection ? (e.cntp = encodeURIComponent(navigator.connection.type), e.cneftp = encodeURIComponent(
                navigator.connection.effectiveType)) : e.cn = 'ns'
            } catch (i) {
              e.cn = 'e_cn'
            }
            try {
              if (navigator.getBattery) {
                ...
                o.then(function(i) {
                  n.comm = JSON.stringify(e), t(h.initialize, n, function(n, e) {
                    n === 'ok' && e && e.success && e.result.code === 0, e && e.result ? e.result : {}
                  }, _.timeout || 1e4)
                })['catch'](function(i) {
 ...
 e.btry = 'ns', n.comm = JSON.stringify(e), t(h.initialize, n, function(n, e) {
                n === 'ok' && e && e.success && e.result.code === 0, e && e.result ? e.result : {}
              }, _.timeout || 1e4) 
}
            } catch (i) {
            ...
            function r() {
              if (p || window.__captchah5__umidToken.indexOf('defaultToken')) {
                ...
                var o = {
                  ...
                  scene: _.scene,
                  p: JSON.stringify(c),
                  n: window.__captchah5__uab.getUA && window.__captchah5__uab.getUA(window.__captchah5_uaboption) || i._n ||
                  (UA_Opt.LogVal ? i[UA_Opt.LogVal] : '') || '',
                  v: a
                };
                t(h.analyze, o, function(t, i) {
                  var o = t === 'ok' && i && i.success && i.result.code === 0;
                    var r = i && i.result ? i.result : {};
        ...
        e.makeSlider = function(n) {
          ...
          function t(e) {
            if (n.fsm.current == 'ready' && !w) {
              w = !0, d();
              var t = v.getBoundingClientRect();
              A = t.left, T = A + t.width - _, b.style.width = t.width + 'px';
              var o = (e.touches ? e.touches[0] : e).clientX;
              x = A - o, i.addEventListener('touchmove', c, !0), i.addEventListener('mousemove', c, !0), n.fire(
                'actionstart')
            }
          }

          function a() {
            w = !1, i.removeEventListener('touchmove', c, !0), i.removeEventListener('mousemove', c, !0), X < T && (o.addClass(
              m, 'mv-back'), o.addClass(y, 'mv-back'), m.style.left = '0', y.style.width = g + 'px', setTimeout(function() {
          ...
          function s() {
            m.addEventListener('touchstart', t), m.addEventListener('touchend', a), m.addEventListener('mousedown', t), m.addEventListener(
              'mouseup', a), k.addEventListener('touchstart', t), k.addEventListener('touchend', a), k.addEventListener(
              'mousedown', t), k.addEventListener('mouseup', a)
          }

          function l() {
            m.removeEventListener('touchstart', t), m.removeEventListener('touchend', a), m.removeEventListener(
              'mousedown', t), m.removeEventListener('mouseup', a), k.removeEventListener('touchstart', t), k.removeEventListener(
              'touchend', a), k.removeEventListener('mousedown', t), k.removeEventListener('mouseup', a)
          }
          ...
          function p(t) {
            h = t, v = e('.slider'), m = e('.button'), y = e('.track'), b = e('.track div'), k = e('.label'), k.innerHTML =
              r.trans(n.options.language, 'LOADING');
        ...
        e.init = function(n, e) {
          ...
          n.onenterpass = function(n, i, o, r) {
            ...
            var a = e.options;
            r.sig = r.sig || r.value, typeof a.callback === 'function' && a.callback(r), e.fire('success');
            var c;
        ...
        e.init = function(n, e) {
          ...
          n.onenterready = function() {
            var n = i('.label');
              var o = 'https://img.alicdn.com/tfs/TB1GhJXQXXXXXa.XFXXXXXXXXXX-75-52.png';
            e.options.isClick ? n.innerHTML = '' : n.innerHTML = t('SLIDER_LABEL');
            var r = e.container.querySelector('.stage2 .textbox');
              var a = r && r.querySelector('input');
            if (r.addEventListener('click', function() {
                a && a.focus()
              }, !1), e.options.logo) {
              var c = e.container.querySelector('.slider');
              c.style.backgroundImage = 'url(' + o + ')', c.style.backgroundPosition = '0 50%', c.style.backgroundRepeat =
                'repeat-x'
            }
            e.fire('ready')
          }
        ...
        e.init = function(n, e) {
          ...
          n.onenterts_fail = function() {
            var n = e.options;
            UA_Opt.Token = (new Date()).getTime() + ':' + n.token, UA_Opt.reload && UA_Opt.reload(), e.updateImg(), i(), e.fire(
              'fail')
          }
        }
      }, function(n, e, t) {
        ...
        e.init = function(n, e) {
          ...
          function c() {
            ...
            function c(t) {
              ...
              o.jsonp(u.get_img, i, function(e, i) {
                var o = e === 'ok' && i && i.success && i.result.resultCode === 0;
                o ? t(i) : e === 'timeout' && n.can('verifyerror') && n.verifyerror(i)
              }, l.timeout || 1e4)
            }

            function f(t) {
              return n.current !== 'ts_verifying' && (t && e.fire('beforeverify'), void c(function(n) {
            ...
            var _; var g = a('img.code');
              var h = a('.input');
              var v = a('.icon.clear');
              var m = a('.icon.refresh');
              var y = a('.btn-ok');
              var b = a('.tips');
              var k = a('.placeholder');
            k.innerHTML = t('TEXTBOX_HOLDER'), y.innerHTML = t('BUTTON_OK'), b.innerHTML = t('TIPS_TITLE'), m.onclick = d,
              g.onclick = d, e.updateImg = f;
            var w = 0;
              var x = 10;
            g.onerror = function() {
              var n = _.indexOf('?') === -1 ? '?' : '&';
          ...
          var s; var l = e.options;
            var u = i[l.foreign] || i[0];
          u = o.mix(u, l.apimap), n.onenterts_loading = function(i, o, r, a) {
            e.slider.setTitle(t('CHECK_N'), 'red'), e.slider.setIcon('no nc-iconfont icon-close'), e.options.verifycallback &&
            e.options.verifycallback(a), setTimeout(function() {
          ...
          n.onenterverifying = function() {
            function n() {
              e.net.postSlide(function(n, t) {
                return i != -1 && clearTimeout(i), n.state === 'timeout' ? void (e.fsm.can('verifyerror') && e.fsm.verifyerror(
                  t)) : (n.pass ? e.fsm.can('verifypass') && e.fsm.verifypass(t) : t.code == 300 ? e.fsm.can('verifyfail') &&
                  e.fsm.verifyfail(t) : e.fsm.can('verifytwostep') && e.fsm.verifytwostep(t), void (e.options.isClick && e
                  .slider.setIcon('nc-hidden')))
              })
            }
            e.slider.disable();
        ...
        'use strict';
        var i =
            '\n<view class="slider">\n    <view class="label"></view>\n    <view class="track">\n        <view class="bg-green"></view>\n    </view>\n    <view class="button">\n        <view class="icon nc-iconfont icon-slide-arrow" id="@prefix@_n1t"></view>\n    </view>\n</view>  \n'
              .trim();
          var o =
            '\n<view class = "click2slider">\n  <view class="click2slide-btn">\n    <view class="icon nc-iconfont icon-load-c nc-loading"></view>\n  </view>\n  <view class="click2slider-label"></view>\n  <view class="slider-holder">\n    <view class="slider">\n        <view class="label"></view>\n        <view class="track">\n            <view class="bg-green"></view>\n        </view>\n        <view class="button">\n            <view class="icon nc-iconfont icon-slide-arrow" id="@prefix@_n1t"></view>\n        </view>\n   </view> \n    </view>\n</view>\n'
              .trim();
        e.make = function(n, e) {
          var t = e ? o : i;
            var r = ('\n    <view class="_nc">\n    <view id="@prefix@-stage-1" class="stage stage1">\n        ' + t +
              '\n    </view>\n    <view id="@prefix@-stage-2" class="stage stage2">\n        <view class="textbox">\n            <input class="input" type="text" maxlength="6" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false">\n            <view class="placeholder">\u9a8c\u8bc1\u7801</view>\n            <view class="icon tip nc-iconfont icon-message"></view>\n            <view class="icon clear nc-iconfont icon-close-white"></view>\n            <view class="icon refresh nc-iconfont icon-refresh"></view>\n            <img class="code" width="100" height="30" alt="">\n        </view>\n        <view class="ope">\n            <button class="btn-ok"></button>\n            <view class="tips"></view>\n        </view>\n    </view>\n    <view id="@prefix@-stage-3" class="stage stage3">\n        <view class="title"></view>\n        <view class="menu refresh">\n            <view class="icon nc-iconfont icon-refresh"></view><view class="label"></view>\n        </view>\n        <view class="menu nc-sep"></view>\n        <view class="menu feedback">\n            <view class="icon nc-iconfont icon-message"></view><view class="label"></view>\n        </view>\n    </view>\n    </view>\n    '
            ).trim();
          return r.replace(/\n\s+/g, '\n').replace(/@prefix@/g, n)
        }
      }, function(n, e, t) {
        ...
        e.makeUI = function(n) {
          ...
          function u(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
              var i = g[h];
            if (i && (i.style.display = 'none'), i = g[e], i.style.display = 'block', h = e, e == 3 && t) {
              var o = document.getElementById(n.prefix + '-stage-3').getElementsByTagName('div')[0].innerHTML;
              o = o + '(' + t + ')', document.getElementById(n.prefix + '-stage-3').getElementsByTagName('div')[0].innerHTML =
                o
            }
            e !== 2 || v.inline || f()
          }
          ...
          function d() {
            function i() {
              var e = a.value.length === 0;
              u.style.display = e ? 'block' : 'none', n.fsm.current === 'ts_verifying' && (e = !0), s.disabled = e, c.style
            ...
            var a = t('.input');
              ...
              var l = t('.tips');
              var u = t('.placeholder');
            u.innerHTML = e('TEXTBOX_HOLDER'), s.innerHTML = e('BUTTON_OK'), l.innerHTML = e('TIPS_TITLE'), setInterval(i,
              500), a.onkeydown = function(n) {
              n.keyCode == 13 ? r() : setTimeout(i, 0)
            }, a.onchange = i, c.onclick = o, s.onclick = r
          }

          function p() {
            var o = t('.menu.refresh');
              var r = t('.menu.feedback');
            o.onclick = function() {
              n.getState() == 'load_error' ? (n.fsm.continueloading(), n.slider.enable()) : n.has('refresh') ? n.fire(
                'refresh') : location.reload()
            }, r.onclick = function() {
              i.open(e('FEEDBACK_URL'))
            }, t('.stage3 .title').innerHTML = e('ERROR_TITLE'), t('.menu.refresh .label').innerHTML = e('ERROR_RELOAD'),
          ...
          return _.setActiveStage = u, _.init = function() {
            o.hide(n.prefix), n.container.innerHTML = r.make(n.prefix, v.isClick), s.addClass(n.container, 'nc-container'),
              n.slider = a.makeSlider(n), n.slider.init(function() {
