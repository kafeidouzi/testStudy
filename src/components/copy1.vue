<template>
    ...
    <div class="StayaboutCarEdit edit-stayboutcar">
        ...
        <div class="us-table-wrapper"  v-loading="loading">
            <div class="us-table-box">
                <table class="us-table" v-if="isOldOrder">
                    ...
                    <tbody>
                    <tr v-for="item of productList" :key="item.productName">
                        <td>
                            <div>
                    ...
                    <table class="us-table" v-if="cartonProductList.length">
                        ...
                        <tbody>
                            <tr v-for="item of cartonProductList" :key="item.id">
                                ...
                                <td>{{item.totalWeight}}</td>
                                <td>{{item.totalVolume? item.totalVolume : '0'}}</td>
                                <td>{{item.number?item.number:'无'}}</td>
                            </tr>
                        </tbody>
                    </table>
        ...
        <!-- <div style="margin-top: 40px;overflow: hidden"> -->
            ...
            <div  v-loading="loading">
                <el-form :model="ruleForm" :rules="rules" :inline="true" ref="ruleForm" label-width="110px" class="detail_form"
                        ...
                        <el-row >
                            <el-col :span="8" v-for="(item,index) of deliveryNumbers" :key="index">
                                <el-form-item :label="'送货单号'+(index+1)+' :'" >
                        ...
                        <div class="split_bar"></div>
                        <el-row >
                            <el-col :span="12"  style="border-right:20px solid #f5f5f5;padding-right:10px;">
                                <h3 class="h-title">发货地信息</h3>
                                <div class="span_wrap" style="background:#E2F1FF;">
                                    <span class="span_one">{{ruleForm.supplierName}}</span>
                                    <span class="span_two">{{ruleForm.supplierLinkman}}</span>
                                ...
                                <div class="span_wrap">
                                    <span class="span_one">{{ruleForm.supplierNumber}}</span>
                                    <span class="span_one">{{ruleForm.supplierAddressDetail}}</span>
                            ...
                            <el-col  :span="12"   v-for="(item,index) of ruleForm.henduokehu" :key="index" style="padding-left:10px;">
                                <h3 class="h-title">收货地信息</h3>
                                <div class="span_wrap" style="background:#E2F1FF;">
                                    <div style="display:flex;align-items:center;" class="span_one">
                                    ...
                                    <span class="span_two">{{item.customerLinkman}}</span>
                                    <!-- <el-form-item label="联系人 :" :prop="'henduokehu.'+index+'.customerLinkman'"    :rules="rules.customerLinkman">
                                        <el-input  class="width-200"  auto-complete="off"  placeholder="请输入联系人"  type="text"  v-model.trim="item.customerLinkman">
                                        </el-input>
                                    </el-form-item> -->
                                </div>
                                <div class="span_wrap">
                                    <span class="span_one">{{item.customerNumber}}</span>
                                    <span class="span_one">{{item.deliveryAddressDetail}}</span>
                        ...
                        <div class="split_bar"></div>
                    <h3 class="h-title">配送信息</h3>
                    <el-row>
                        <el-col :span="8">
                            <el-form-item label="总重量" prop="totalAllWeight">
                                <el-input class="width-300"  auto-complete="off" placeholder="请输入总面积"
                                        type="text"  v-model.trim="ruleForm.totalAllWeight "></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="总体积" prop="totalAllVolume">
                                <el-input  class="width-300" auto-complete="off" placeholder="请输入总体积"
                                        type="text"  v-model.trim="ruleForm.totalAllVolume "></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="参考距离" prop="distance">
                            <el-input disabled class="width-300" auto-complete="off" placeholder="请输入参考距离"
                                      type="text" v-model.trim="ruleForm.distance"></el-input>
                            <el-button type="text" v-if="recalcBtnVisible"
                                       @click="reCalcDistanceHandle" :disabled="recalcBtnDisable">重新计算距离
                            </el-button>
                        </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="8">
                            <el-form-item prop="takingDate" label="发货日期">
                        ...
                        <el-col :span="8">
                            <el-form-item prop="deliveryDate" label="最晚送货日期">
                                <!-- <el-date-picker class="width-235" type="date" placeholder="选择日期"
                    ...
                    <div class="Serviceselection" style="clear: both">
                        <el-form-item label="服务选择" prop="delivery">
                            <div v-for="(item,index) of severlists" style="float: left;margin-right: 52px" :key="index">
                    ...
                    <div class="Modelschoose" style="clear: both">
                        <el-form-item label="车型选择"  style="margin-right:0px;">
                        </el-form-item>
                        <div class="vt" v-for="(item,index) of ruleForm.truckList" :key="index">
                    ...
                    <div class="split_bar"></div>
                    <div  v-show="ruleForm.carAndDriverList.length>0" >
                        <h3 class="h-title">车辆信息</h3>
                        <div v-for="(item,index) of ruleForm.carAndDriverList" v-loading="loading" :key="index">
                        <el-row style="display:flex;flex-wrap:wrap;"  >
                                <el-col :span="6" class="span_three" style="background:#E2F1FF;">{{item.driverName}}</el-col>
                                <el-col :span="6" class="span_three" style="background:#E2F1FF;">{{item.plateNumber}}</el-col>
                                <el-col :span="6" class="span_three" style="background:#E2F1FF;">{{item.driverPhone}}</el-col>
                                <el-col :span="6" class="span_three" style="background:#E2F1FF;">{{item.truckType}}</el-col>
                                <!-- <el-row style="width:100%;"   v-for="(ite,index) in item.driverClockInVoList"  :key="index"> -->
                                <el-col v-if="condition3" :span="6" class="span_three">{{item.driverClockInVoList[0].isClockIn === false ? '装货未打卡':'装货已打卡'}}</el-col>
                                <el-col v-if="condition3" :span="6" class="span_three" >{{item.driverClockInVoList[0].time ? (item.driverClockInVoList[0].time | formatDate): '-'}}</el-col>
                                <el-col v-if="condition3" :span="6" class="span_three" >{{item.driverClockInVoList[1].isClockIn === false ? '卸货未打卡':'卸货已打卡'}}</el-col>
                                <el-col v-if="condition3" :span="6" class="span_three" >{{item.driverClockInVoList[1].time ? (item.driverClockInVoList[1].time |formatDate) :'-'}}</el-col>
                                <!-- </el-row> -->
                        </el-row>
                                ...
                                <el-form-item  style="width:100%">
                                    <div class="allcareimg" v-show="item.shipmentDriverOrderFileVoList.length>0">
                                        <viewer>
                                            <el-row>
                                                <el-col :span="8" 
                                                    v-for="(value,index) of item.shipmentDriverOrderFileVoList" :key="index">
                                                    <div class="singlimg">
                            ...
                            <div class="Deliverydistance" >
                                <el-form-item  style="width:100%">
                                    <div class="allcareimg" v-show="item.unloadDriverOrderFileVoList.length>0" >
                                        <viewer>
                                            <el-row style="display:flex;flex-wrap:wrap;">
                                                <el-col :span="8"  v-for="value of item.unloadDriverOrderFileVoList" :key="value.url">
                                                    <div class="singlimg">
                                                        <img :src="value.url" style="width: 100%;height: 100%"/>
                                                        <span>{{value.fileTypeName}} {{ value.deliveryNumber }}</span>
                                                    </div>
                                                    <!-- DS单号、送货单号 -->
                    ...
                    <!-- <div style="margin-top: 40px;overflow: hidden" v-for="(item) of ruleForm.carAndDriverList" :key="item.plateNumber"> -->
                        <template v-if="item.unusualDriverOrderFileVoList.length">
                            <h3 class="h-title">异常信息</h3>
                            <div  v-loading="loading">
                                <div class="Deliverydistance;" 
                                    v-for="(value,index) of item.unusualDriverOrderFileVoList" :key="index">
                                        <div class="allcareimg">
                                            <viewer>
                                                <el-row >
                                                    <el-col :span="8"   v-for="i of value.fileList" :key="i.url">
                                                        <div class="singlimg">
                                    ...
                                    <el-row style="margin-bottom:20px;">
                                        <el-col :span="8">异常类型 :{{value.abnormalTypeName}}</el-col>
                                        <el-col :span="8">异常原因 :{{value.unusualInfo}}</el-col>
                                        <el-col :span="8">上传地点 :{{value.location}}</el-col>
                                    </el-row>
                    ...
                    <div  v-loading="loading" style="margin-bottom:120px;">
                        <el-row>
                            <el-col :span="8">
                            ...
                            <el-col :span="8">
                                ...
                                <el-form-item label="承运商接单模式" prop="buttonType">
                                    <el-select placeholder="选择承运商接单模式" class="width-300"
                                               :disabled="ruleForm.orderStatus !== '0'" v-model="ruleForm.buttonType">
                                        <el-option
                        ...
                        <el-row v-if="orderKind === 'FC'">
                            <el-col :span="8">
                                <el-form-item label="是否配送仓库" prop="isWarehouse">
                                    <el-radio-group v-model="ruleForm.isWarehouse" >
                                      <el-radio :disabled="isDisable === 1 ? true : false" :label="0">否</el-radio>
                                      <el-radio :disabled="isDisable === 1 ? true : false" :label="1">是</el-radio>
                                    </el-radio-group>
                                </el-form-item>
                            </el-col>
                            <el-col :span="8" v-show="ruleForm.isWarehouse === 1" >
                                <el-form-item prop="warehouseId" label="仓库选择" >
                                    <el-select class="width-300" v-model="ruleForm.warehouseId" :disabled="isDisable === 1 ? true : false" placeholder="请选择仓库">
                                      <el-option
                        ...
                        <el-row style="display:flex;flex-wrap:wrap;">
                            ...
                            <el-col :span="8" v-for="(item,index) of ruleForm.confirmhua" :key="item.id">
                        ...
                        <h3 class="h-title">异常信息</h3>
                        <el-row v-if="exceptionTypeOptionVisible">
                            <el-col>
                        ...
                        <el-row v-for="(item,index) of ruleForm.otherCost" :key="index">
                            <el-col :span="8">
                                <el-form-item :label="filterType(item.abnormalType)"
                                              :prop="'otherCost.'+index+'.abnormalCost'" :rules="rules.otherCost">
                                    <el-input class="width-300" auto-complete="off" placeholder="请输入异常费用"
                                            type="text" v-model.trim="item.abnormalCost"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                                <el-form-item label="异常原因">
                                    <el-input  class="width-300" auto-complete="off" placeholder="请输入异常原因"
                                            type="text" v-model.trim="item.abnormalReason"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row>
                            <el-col :span="8">
                                <el-form-item label="KPI扣款" prop="kpiCost">
                                    <el-input class="width-300" auto-complete="off" placeholder="请输入扣款费用"
                                            type="text" v-model.trim="ruleForm.kpiCost"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                                <el-form-item label="扣款原因">
                                    <el-input class="width-300" auto-complete="off" placeholder="请输入扣款原因"
                                            type="text" v-model.trim="ruleForm.kpiReason"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                           <el-row>
                               <el-col :span="8">
                                   <el-form-item label="索赔金额" prop="claimantCost">
                                    <el-input class="width-300" auto-complete="off" placeholder="请输入索赔金额"
                                            type="text" v-model.trim="ruleForm.claimantCost"></el-input>
                                </el-form-item>
                               </el-col>
                               <el-col :span="12">
                                   <el-form-item label="索赔原因">
                                    <el-input class="width-300" auto-complete="off" placeholder="请输入索赔原因"
                                            type="text" v-model.trim="ruleForm.claimantReason"></el-input>
                                </el-form-item>
                               </el-col>
                           </el-row>
                            <div >
                                <el-form-item label="合计费用" prop="totalCost">
                                    <el-input disabled class="width-300" auto-complete="off"
                                              placeholder="请输入备注"  type="text" v-model="ruleForm.totalCost">
                                    </el-input>
                                    <span v-show="false">{{jisuan}}</span>
                                </el-form-item>
                            </div>
                            <div class="StayaboutCarEditremark " >
                                <el-form-item label="备注" prop="carrierRemark">
                                    <el-input class="width-480" auto-complete="off" placeholder="请输入备注"
                                            type="textarea" v-model="ruleForm.carrierRemark">
                                    </el-input>
                                </el-form-item>
                            </div>
                    </div>
                    <!-- <div class="split_bar"></div>
                    <h3 class="h-title">卸货信息</h3>
                    <div v-if="(orderKind === 'OF'|| orderKind === 'FC') && condition1 " >
                        <el-table 
		                	:data="tableData1"
		                	style="width: 100%"
                            border
                            class="confirm-stock-table">
		                	...
		                	<el-table-column
		                		...
		                		<template slot-scope="scope" >
                                    <el-button v-if="item.label === '操作'" type="text" 
                                    :disabled="(scope.row.planNumber - scope.row.actualNumber === 0)|| !(condition1 && condition2) ? true:false"  @click="showDiog(scope.row,scope.$index)">差异原因</el-button>
                                    <el-input v-else-if="item.label === '实收数量'"     
                                        v-model.number="scope.row[scope.column.property]" 
                                        @blur="changeActualQty(scope.row,scope.$index)"
                                        :placeholder="scope.row[scope.column.property]"
                                        :disabled="!(condition1 && condition2)"
                                    ></el-input>
                                    <div v-else-if="item.label === '差异数量'">
                                        {{scope.row.actualQty === null || scope.row.actualQty === ''||scope.row.planQty - scope.row.actualQty === 0 ? '-': scope.row.planNumber - scope.row.actualNumber}}</div>
                        ...
                        <div class="bill-confirm" >
                            <el-button type="primary"  
                                :disabled="!(condition1 && condition2)" @click="billConfirm">确 定
                            </el-button>
                        </div>
                    </div> -->
                    ...
                    <div  v-show="ruleForm.carAndDriverList.length>0">
                        <h3 class="h-title">车辆信息</h3>
                        <el-row style="display:flex;flex-wrap:wrap;"  v-for="(item,index) of ruleForm.carAndDriverList"
                             v-loading="loading" :key="index">
                                <el-col :span="8" class="span_three" style="background:#E2F1FF;">{{item.driverName}}</el-col>
                                <el-col :span="8" class="span_three" style="background:#E2F1FF;">{{item.plateNumber}}</el-col>
                                <el-col :span="8" class="span_three" style="background:#E2F1FF;">{{item.driverPhone}}</el-col>
                            <el-col :span="8" class="span_three">{{item.truckType}}</el-col>
                            <el-col :span="8" class="span_three">{{item.driverName}}</el-col>
                        </el-row>
                        <el-divider></el-divider>
                    </div> -->
                        <!-- <div >
        ...
        <div class="change-btn-wrapper">
            ...
            <el-button :disabled="orderKind === 'OF'"  v-show="ruleForm.orderStatus!=='5'" style="width:150px;padding: 0px 40px"
                       class="change-btn btn-default" type="primary"
                       @click="centerDialogVisible3=true">
                订单取消
            </el-button>
            <el-button style="width:150px;border-radius: 2px" type="primary" @click="updateinfomation">
                确定
            </el-button>
        </div>
        ...
        <el-dialog title="差异数量" :visible.sync="dialogFormVisible">
          <el-form :model="form" ref="form">
            <el-row>
              <div class="btn-wrapper">
                <el-button type="primary"  @click="addDomain">添  加</el-button>
              </div>
            </el-row>
            <el-row :gutter="20" class="row-header">
              <el-col :span="2">序号</el-col>
              <el-col :span="7" :offset="1">差异原因</el-col>
              <el-col :span="7">差异数量</el-col>
            ...
            <div 
              ...
              <el-row  :gutter="20">
                <el-col :span="1">
                  <el-form-item :label="index + 1+''"></el-form-item>
                </el-col>
                ...
                <el-col :span="7">
                  <el-form-item
                    ...
                    <el-input-number :min="1" v-model="domain.quantity" aria-placeholder="请输入差异数量"   :style="{width:'200px'}" ></el-input-number>
                  </el-form-item>
                </el-col>
                <el-col :span="6" >
        ...
        <Tip ref="orderCommonTips" :context="message"></Tip>
        <Reason ref="reasonlist" :reasonList="reasonList"></Reason>
    </div>
</template>
...
<script>
    ...
    import Tip from '../Inventory/common/Tip'
    import Reason from '../Inventory/common/ShowReason'
    export default {
        data() {
            ...
            let warehouseId = (rule, value, callback) => {
                if (this.ruleForm.isWarehouse === 1 && value === '') {
        ...
        created() {
            let str = this.$route.query.logisticsNumber
            this.orderKind = str.substring(0,2)
            this.getManageList();
            // this.getserverlist();
            this.getorderdetail();
            // this.getprovince();
        ...
        methods: {
            getValue(val) {
              ...
              if(idx === -1) {
                ...
                this.message = '差异原因不能相同'
                this.$refs.orderCommonTips.showVisible()
              }
              console.log(val)
            },
            showReason(row) {
                this.reasonList = row.items
                this.$refs.reasonlist.show()
            },
            //获取差异原因列表
            getReanson() {
             let url = '/api/wms/inventory/differenceTypeList'
             this.$axios.get(url)
               .then(res=> {
            ...
            getWarehouseList() {
                let url = '/api/sys/carrierOrder/getWarehouseInfo'
                this.$axios.get(url)
                    .then(res => {
                        if(res.data.code === 200) {
                ...
                this.$axios.get(url)
                    .then(res => {
                        ...
                        if (res.data.code === 200) {
                            ...
                            this.condition1 = res.data.data.carrierOrderStatus === 5? true:false
                            let arr = []
                            this.condition2 = res.data.data.driverOrderFileDetailsVoList.every(item=>{
                                // let ite = item.driverOrderStatus === 3 ? true :false
                                // arr.push(ite)
                                return item.driverOrderStatus === 3
                            })
                            // this.condition2 = arr.every(item=>{
                            //     item ===true
                            // })
                            ...
                            //是否选择仓库判断值
                            this.isDisable = res.data.data.carrierOrderDetailsVo.isWarehouse
                            console.log(this.isDisable)
                            this.ruleForm.isWarehouse = res.data.data.carrierOrderDetailsVo.isWarehouse === '' || res.data.data.carrierOrderDetailsVo.isWarehouse === null ?  0 : res.data.data.carrierOrderDetailsVo.isWarehouse
                            //仓库ID
                            this.ruleForm.warehouseId = res.data.data.carrierOrderDetailsVo.isWarehouse === 1 ? res.data.data.carrierOrderDetailsVo.warehouseId :null
                            //表单确认数据
                            this.tableData1 = res.data.data.goodsInfoVos
                        ...
                        if (this.isclick) {
                            ...
                            let params = {
                                ...
                                carrierOrderDetailsVo: {
                                    ...
                                    isWarehouse:this.ruleForm.isWarehouse,
                                    warehouseId:this.ruleForm.isWarehouse === 1? this.ruleForm.warehouseId :null
                                },
                                carrierOrderCostVo: {
                                    distance: this.ruleForm.distance,
            ...
            showDiog(row,index) {
              ...
              if(index === this.idx) {
                this.form.domains = this.tableData1[this.idx].items.length !== 0 ? this.tableData1[this.idx].items : this.form.domains
              } else {
                this.idx = index
                this.form.domains = [{
                   type: null,
              ...
              this.planNum = this.tableData1[this.idx].planNumber
              this.realNum = this.tableData1[this.idx].actualNumber
              this.tableData1[this.idx].differenceNumber = this.planNum - this.realNum
            },
            changeActualQty(row,index) {
                this.idx = index
                this.form.domains = [{
                      type: null,
                      quantity: null
                    }]
                this.tableData1[this.idx].differenceNumber = row.planNumber -row.actualNumber
            },
            cancel() {
                this.form.domains = [{
                   type: null,
            ...
            onSubmit() {
              this.$refs.form.validate((valid) => {
                  if (valid) {
                    console.log(this.form.domains)
                    let leng = this.form.domains.length
                    let sum = null
                    switch(leng) {
                      case 1:
                        sum = this.form.domains[0].quantity;
                        break;
                      case 2:
                        sum = this.form.domains[0].quantity + this.form.domains[1].quantity;
                        break
                      case 3:
                        sum = this.form.domains[0].quantity + this.form.domains[1].quantity + this.form.domains[2].quantity;
                        break
                      default:
                        sum = null;
                    }
                    console.log(this.planNum,this.realNum)
                    let diff = Math.abs(this.planNum - this.realNum)
                    if(diff !== sum) {
                        this.message = '差异数量存在差异'
                        this.$refs.orderCommonTips.showVisible()
                    } else {
                        this.tableData1[this.idx].items = this.form.domains
                        console.log(this.tableData1)
                        this.form.domains = [{
                             type: null,
                             quantity: null
            ...
            removeDomain(item) {
              ...
              if (index !== -1 && this.form.domains.length >1) {
                this.form.domains.splice(index, 1)
              }
            },
            billConfirm() {
                let blo = this.tableData1.every((item,index)=> {
                    this.itemIndex = index
                    let plan =  Math.abs(item.planNumber -item.actualNumber)
                    let sum = 0
                    item.items.forEach((item)=> {
                        sum +=  Math.abs(item.quantity)
                    })
                    return sum === plan
                })
                if(blo) {
                    console.log(11)
                    let url = '/api/sys/deliveryNumber/confirmBill'
                    this.$axios.post(url,this.tableData1)
                        .then(res=> {
                            console.log(res)
                            if(res.data.code === 200) {
                                this.getorderdetail()
                    ...
                    this.message = this.itemIndexTips
                    this.$refs.orderCommonTips.showVisible()
                }
            },
        },
        computed: {
            ...
            itemIndexTips() {
                return `第${this.itemIndex +1}条差异原因数量存在差异`
            }
        },
        watch: {
            // 卡车类型变化后
